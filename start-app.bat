...
start "Climate Tracker - Backend" cmd /c "cd backend && python -m venv venv && venv\Scripts\activate && pip install -r requirements.txt && python start_dev.py && pause"

echo Waiting for backend to initialize...
timeout /t 5 /nobreak > nul

echo Starting frontend...
start "Climate Tracker - Frontend" cmd /c "cd frontend && npm install && npm run dev && pause"
